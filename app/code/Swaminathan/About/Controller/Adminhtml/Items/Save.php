...
class Save extends \Swaminathan\About\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('aboutus');
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('swaminathan_about/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('swaminathan_about/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('swaminathan_about/*/new');
                }
                return;
            } catch (\Exception $e) {
