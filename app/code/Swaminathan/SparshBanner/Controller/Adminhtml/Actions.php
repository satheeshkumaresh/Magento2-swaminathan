<?php
namespace Swaminathan\SparshBanner\Controller\Adminhtml;

class Actions extends \Sparsh\Banner\Controller\Adminhtml\Actions
{
    /**
     * Form session key
     *
        ...
        try {
            ...
            if ($request->getParam('banner_id') == null) {
                if (array_key_exists('banner_image', $model->getData())
                    ...
                    $model->setData('creation_time', date('y-m-d h:i:s'));
