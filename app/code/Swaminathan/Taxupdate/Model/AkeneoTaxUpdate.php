<?php
namespace Swaminathan\Taxupdate\Model;
...
class AkeneoTaxUpdate implements \Swaminathan\Taxupdate\Api\AkeneoTaxUpdateInterface
{
    ...
    const AKENEO_TAX_ATTRIBUTE_CODE = "gst_tax_class";
        ...
        public function taxUpdate(){
                ...
                foreach($collection as $data){
                        ...
                        $response[] = ["code" => 200,'success' => true, 'message' =>"Tax Updated Successful"];     
                     }
                     else{
                        $response[] = ["code" => 400,'success' => true, 'message' =>"Tax Already Updated"];
                     }
                  } 
